...
function PrintFilterReportsO() {
  ...
  const { data, isLoading, message, clearMessage } = useFetchAll(
    `/api/bookings/date/print/worker/?from_date=${fromDate}&to_date=${toDate}&search=${search}&worker_id=${worker}`
  );
...
export default PrintFilterReportsO;
