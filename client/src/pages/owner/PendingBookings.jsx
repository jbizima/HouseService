...
import ApproveBookingModal from "@/components/owner/ApproveBookingModal";

function PendingBookingsO() {
  ...
  return (
    <div className="dashboard--content category">
      ...
      <BookingTable bookings={booking.data ? booking.data : []} openApproveModal={handleModal} />
      {booking.isLoading && (
...
export default PendingBookingsO;
